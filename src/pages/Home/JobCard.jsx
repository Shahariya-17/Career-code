...
const JobCard = ({ job }) => {
  ...
  return (
    <div className="border border-gray-200 rounded-2xl p-6 shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300 bg-white max-w-sm">
      {/* Header */}
      ...
      <div className="flex items-center text-gray-400 text-sm mb-3 space-x-4">
        <span className="flex items-center gap-1">🕒 {jobType}</span>
        <span className="flex items-center gap-1">⏱ Just now</span>
      </div>
